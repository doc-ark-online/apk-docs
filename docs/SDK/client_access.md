...
| SDK版本号 | 修订日期 | 说明 |
| --------- | ---------- | ------- |
| V3.2.18    | 2025/01/14 |  1.优化隐私协议弹窗UI适配问题 |
...
下载[内购SDK](https://release.233leyuan.com/online/PFQ93FIiBfwt1768372777235.zip)解压并将**mpg-pay-\*.aar**复制到您项目Project/app/libs文件夹下。
...
dependencies {
    ...
    implementation files('libs/mpg-pay-v3.2.18.aar')
